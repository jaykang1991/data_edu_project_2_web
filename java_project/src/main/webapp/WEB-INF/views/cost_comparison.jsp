...
<body>
  <header>
    <div class="navbar navbar-default">
      ...
      <section>
        <div class="container">
            <div class="row"><h3>도시/농촌 지출 비교</h3></div><br/><br/><br/><br/>
            <div class="row">
                <div class="col-sm-8 item_button">
                    <h4 class="map_name">Treemap</h4>
                    <a href="#" data-toggle="modal" data-target="#squarespaceModal-ini_method">
                        <img class="rounded-circle map_img" alt="Treemap" src="<c:url value="/resources/img/city_farm_cost_compare_treemap.PNG"/>" data-holder-rendered="true">
                      </a>
                </div>
                    
                <div class="col-sm-8 item_button">
                  <h4 class="map_name">Barchart</h4>
                  <a href="#" data-toggle="modal" data-target="#squarespaceModal-ini_usage">
                    <img class="rounded-circle map_img" alt="Barchart" src="<c:url value="/resources/img/city_farm_cost_compare_bar.PNG"/>" data-holder-rendered="true">
                  </a>
                </div>
              </div>
          </div>
                        ...
                        <div class="modal-content">
                          <div class="container">
                            <div class="row title_ini">
                              ...
                              <h2>도시/농촌 지출 비교 - Treemap</h2></div><br/>
                            <div class="row">
                                <img src="<c:url value="/resources/img/city_farm_cost_compare_treemap.PNG"/>" width="860px" height="500px">
                        ...
                        <div class="modal-content">
                          <div class="container">
                            <div class="row title_ini">
                              ...
                              <h2>도시/농촌 지출 비교 - Barchart</h2></div><br/>
                            <div class="row">
                                <img src="<c:url value="/resources/img/city_farm_cost_compare_bar.PNG"/>" width="860px" height="500px">
