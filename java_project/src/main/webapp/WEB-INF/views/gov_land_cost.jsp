...
<body>
  <header>
    <div class="navbar navbar-default">
      ...
      <section>
              <div class="container">
                  <div class="row"><h3>정부지원금/농지가격</h3></div><br/><br/><br/><br/>
                  <div class="row">
                      <div class="col-sm-8 item_button">
                          <h4 class="map_name">농업 정부지원금 추세</h4>
                          <a href="#" data-toggle="modal" data-target="#squarespaceModal-ini_method">
                              <img class="rounded-circle map_img" src="<c:url value="/resources/img/gov_aid.png"/> " alt="농업 정부지원금 추세" data-holder-rendered="true">
                          	  
                          </a>
                          </button>
                      </div>
                      <div class="col-sm-8 item_button">
                        <h4 class="map_name">지역별 농지 가격 추세</h4>
                        
                        
                          <a href="#" data-toggle="modal" data-target="#squarespaceModal-ini_usage">
                          <img class="rounded-circle map_img" src="<c:url value="/resources/img/farm_property.png" />"alt="농지가격" data-holder-rendered="true">
                  ...
                  <div class="modal-content">
                    <div class="container">
                      <div class="row title_ini">
                        ...
                        <h2>농업 정부지원금 추세</h2></div><br/>
                      <div class="row">
                          <img src="<c:url value="/resources/img/gov_aid.png" />"width="890px" height="500px">
                  ...
                  <div class="modal-content">
                    <div class="container">
                      <div class="row title_ini">
                        ...
                        <h2>지역별 농지 가격 추세</h2></div><br/>
                      <div class="row">
                          <img src="<c:url value="/resources/img/farm_property.png" />"width="890px" height="600px">
                      </div> </div>
                  </div> </div>      
              </div>
            </section>
